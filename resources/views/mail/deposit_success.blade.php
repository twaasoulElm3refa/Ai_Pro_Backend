...
<body style="margin:0;padding:0;background:#f5f7fa;font-family:Arial">
    ...
    <div style="max-width:600px;margin:40px auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.05)">
        ...
        <div style="background:linear-gradient(135deg,#10b981,#059669);padding:30px;text-align:center;color:white">
            <h1 style="margin:0;font-size:24px">✅ تم الشحن بنجاح</h1>
        </div>
        ...
        <div style="padding:30px;text-align:center">
            ...
            <div style="margin:25px 0;font-size:28px;font-weight:bold;color:#10b981">
                {{ $currency }} {{ $amount }}
            </div>

            <p style="color:#9ca3af">
                يمكنك الآن استخدام الرصيد في حسابك
            </p>

            <!-- Button -->
            <a href="{{ config('app.url') }}"
               style="display:inline-block;margin-top:20px;padding:14px 30px;background:#10b981;color:white;text-decoration:none;border-radius:12px;font-weight:bold">
                الذهاب إلى الحساب
            </a>
