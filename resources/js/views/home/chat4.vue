...
html[data-theme="dark"] .detector-chat .workspace-header,
...
html[data-theme="dark"] .detector-chat .workspace-header h1,
html[data-theme="dark"] .detector-chat .welcome-card h2,
html[data-theme="dark"] .detector-chat .ai-response-title,
html[data-theme="dark"] .detector-chat .business-name,
html[data-theme="dark"] .detector-chat .assistant-typing-text {
    color: var(--theme-text-primary);
}

html[data-theme="dark"] .detector-chat .sidebar-brand small,
html[data-theme="dark"] .detector-chat .section-label,
html[data-theme="dark"] .detector-chat .welcome-card p,
html[data-theme="dark"] .detector-chat .result-title-stack span,
html[data-theme="dark"] .detector-chat .business-domain-label,
html[data-theme="dark"] .detector-chat .options-summary,
...
html[data-theme="dark"] .detector-chat .copy-card-button,
html[data-theme="dark"] .detector-chat .result-header button,
html[data-theme="dark"] .detector-chat .ai-edit-options-button,
html[data-theme="dark"] .detector-chat .options-panel,
html[data-theme="dark"] .detector-chat .option-card,
html[data-theme="dark"] .detector-chat .checkbox-option,
html[data-theme="dark"] .detector-chat .resume-file-button,
html[data-theme="dark"] .detector-chat .options-reset-button,
html[data-theme="dark"] .detector-chat .input-box,
html[data-theme="dark"] .detector-chat .composer-file-button,
...
html[data-theme="dark"] .detector-chat .icon-button:hover,
html[data-theme="dark"] .detector-chat .suggestion:hover,
html[data-theme="dark"] .detector-chat .ai-edit-options-button:hover:not(:disabled) {
...
html[data-theme="dark"] .detector-chat .message-content,
html[data-theme="dark"] .detector-chat .assistant-typing-content,
html[data-theme="dark"] .detector-chat .ai-response-card,
html[data-theme="dark"] .detector-chat .business-response-card,
html[data-theme="dark"] .detector-chat .business-result-card,
html[data-theme="dark"] .detector-chat .user-uploaded-file-card,
html[data-theme="dark"] .detector-chat .ai-meta-section {
    background: var(--theme-surface-secondary);
    color: var(--theme-text-primary);
    border-color: var(--theme-border);
...
html[data-theme="dark"] .detector-chat .user .message-content {
    background: linear-gradient(135deg, #154677, #2ba6de);
    color: #ffffff;
    border-color: transparent;
}

html[data-theme="dark"] .detector-chat .ai-response-header,
html[data-theme="dark"] .detector-chat .result-header,
html[data-theme="dark"] .detector-chat .ai-score-box {
    background: var(--theme-surface-elevated);
    color: var(--theme-text-primary);
}

html[data-theme="dark"] .detector-chat .domain-chip,
html[data-theme="dark"] .detector-chat .tool-badges span {
    background: rgba(43, 166, 222, 0.10);
    color: var(--theme-accent);
    border-color: rgba(43, 166, 222, 0.24);
}

html[data-theme="dark"] .detector-chat .options-basic-grid input,
html[data-theme="dark"] .detector-chat .options-basic-grid select,
...
html[data-theme="dark"] .detector-chat .options-basic-grid input:focus,
html[data-theme="dark"] .detector-chat .options-basic-grid select:focus,
...
html[data-theme="dark"] .detector-chat .resume-file-selected button {
