<template>
    <main class="chat-root" :class="{ 'sidebar-collapsed': desktopSidebarCollapsed }"
        ...
        <div class="main-area">
            ...
            <div class="messages-wrap" ref="messagesContainer" role="log" aria-live="polite"
                ...
                <div v-else-if="messages.length === 0" class="empty-state">
                    ...
                    <button
                        ...
                        :disabled="creatingConversation || sendingMessage || streamingAssistant"
                        @click="startNewChat"
                    >
                        ...
                        <span>{{ creatingConversation ? t("user.chat.creating") : createConversationLabel }}</span>
                    </button>
            ...
            <div v-if="hasActiveConversation" class="input-area">
...
html[data-theme="dark"] .chat-root {
    ...
    --soft-bg: var(--theme-surface-secondary);
    --soft-bg-2: var(--theme-surface-secondary);
    --result-bg: var(--theme-surface-secondary);
    --result-head-bg: var(--theme-surface-elevated);
    --badge-bg: rgba(43, 166, 222, 0.10);
    --error-text: #f87171;
